...
function revealSpecificElement(targetElement) {
...
function show() {
  ...
  function showx() {
    var reveals = document.querySelectorAll(".showx");
  ...
  //neew animation for photos 
  function phoo() {
    var reveals = document.querySelectorAll(".phoo");
  ...
  window.addEventListener("scroll", phoo);



  function toggleVisibility(linkId, contentId) {
...
document.getElementById('events-link').addEventListener('click', function () {
    toggleVisibility('events-link', 'events-list');
});

document.getElementById('partnership-link').addEventListener('click', function () {
    toggleVisibility('partnership-link', 'partnership-list');
});

document.getElementById('community-link').addEventListener('click', function () {
    toggleVisibility('community-link', 'community-list');
});

document.getElementById('company-link').addEventListener('click', function () {
    toggleVisibility('company-link', 'company-list');
});
